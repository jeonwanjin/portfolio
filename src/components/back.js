...
function Back() {
    ...
    useEffect(() => {
        ...
        // 입자
        const particlesGeometry = new THREE.BoxGeometry(0.0001,0.005,0.0001);  // 입자의 크기임
        ...
        for (let i = 0; i < 30000; i++) {
            ...
            particlesMesh.position.x = (Math.random() - 0.5) * (Math.random() * 5);
            particlesMesh.position.y = (Math.random() - 0.5) * (Math.random() * 20);
